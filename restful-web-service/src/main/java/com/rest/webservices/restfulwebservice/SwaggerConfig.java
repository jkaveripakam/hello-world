...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Jagan Kaveripakam", "http://jagan", "my own website");
	  public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Api Documentation", "Api Documentation", "1.0", "urn:tos",
	          DEFAULT_CONTACT, "Apache 2.0", "http://www.apache.org/licenses/LICENSE-2.0");
	private static final ApiInfo DEFAULT_API_INFO1 = null;
